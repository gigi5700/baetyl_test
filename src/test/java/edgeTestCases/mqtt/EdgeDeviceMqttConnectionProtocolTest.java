...
import edgeTestCases.utils.CheckCommon;
...
/**
 * Test cases for protocol connection of edgeTestCases.mqtt device
 *
 * @author Zhao Meng
 */
...
public class EdgeDeviceMqttConnectionProtocolTest extends EDGEIntegrationTest {
    ...
    /**
     * TestGoal: Test connecting edgeTestCases.mqtt with different supported protocols
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * TestGoal: Test connecting edgeTestCases.mqtt with missing cert in ssl context
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * TestGoal: Test connecting edgeTestCases.mqtt with wrong cert in ssl context
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * TestGoal: Test connecting edgeTestCases.mqtt with a cert in non-ssl context
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * TestGoal: Test connecting edgeTestCases.mqtt with illegal protocols
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * TestGoal: Test connecting edgeTestCases.mqtt twice with the same client
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * TestGoal: Test connecting edgeTestCases.mqtt with two-way tls mode and check msg re-forward and illegal scenarios.
     *
     * @throws Exception
     */
    @Test
