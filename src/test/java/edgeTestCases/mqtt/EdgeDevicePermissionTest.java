...
/**
 * Test cases for permission check of edgeTestCases.mqtt device
 *
 * @author Zhao Meng
 */
@Slf4j
public class EdgeDevicePermissionTest extends EDGEIntegrationTest {
    ...
    /**
     * TestGoal: Test operation permission checker of edgeTestCases.mqtt broker.
     *
     * Main steps:
    ...
    /**
     * TestGoal: Test topic permission checker of edgeTestCases.mqtt broker(There should be fail flag in suback when subscribing
    ...
    /**
     * TestGoal: Test subscribing overlap topics and check edgeTestCases.mqtt will forward msgs according to qos.
     *
     * @throws Exception
     */
    @Test
