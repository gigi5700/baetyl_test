...
/**
 * Test cases for edgeTestCases.mqtt features of edgeTestCases.mqtt device
 *
 * @author Zhao Meng
 */
@Slf4j
...
public class EdgeDeviceMqttFeatureTest extends EDGEIntegrationTest {
    ...
    /**
     * TestGoal: Test clean session feature of edgeTestCases.mqtt broker(Parameterized).
     *
     * Main steps:
    ...
    /**
     * TestGoal: Test retain feature of edgeTestCases.mqtt broker(Parameterized).
     *
     * Main steps:
    ...
    /**
     * TestGoal: Test last will feature of edgeTestCases.mqtt broker.
     *
     * Main steps:
    ...
    /**
     * TestGoal: Test last will retain feature of edgeTestCases.mqtt broker.
     *
     * Main steps:
