...
import edgeTestCases.utils.msg.EdgeDeviceMsgForComplexSelect;
import edgeTestCases.utils.msg.EdgeDeviceNestMsg;
import edgeTestCases.utils.msg.EdgeDeviceSimpleMsg;
import edgeTestCases.utils.msg.RuleDataMsg;
...
public class EdgeDeviceReSQLTest extends EDGEIntegrationTest {
    ...
    /**
     * TestGoal: Test customized sql functions in select clause of subscriptions(mainly about edge mqtt features)
     *
     * @throws Exception
     */
    @Test
