...
import edgeTestCases.utils.msg.EdgeDeviceNestMsg;
import edgeTestCases.utils.msg.EdgeDeviceSimpleMsg;
...
/**
 * Test cases for destination check of edgeTestCases subscriptions.
 *
 * @author Zhao Meng
 */
@Slf4j
public class EdgeDeviceReDestTest extends EDGEIntegrationTest {
    ...
    public void testSubscriptionWithMultiDest() throws Exception {
        ...
        for (EdgeDeviceSimpleMsg msg : pubMsgs) {
            ...
            // Add edgeTestCases.mqtt result msg
    ...
    public void testChainSubscription() throws Exception {
        // chain/test/1 -> chain/test/2 -> $edgeTestCases.function/simple_sql -> $edgeTestCases.function/simple_python -> chain/test/3
    ...
    public void testSubscriptionWithAcrossPrincipal() throws Exception {
        ...
        // across/result -> $edgeTestCases.function/simple_sql -> across/back(back to the origin one)
