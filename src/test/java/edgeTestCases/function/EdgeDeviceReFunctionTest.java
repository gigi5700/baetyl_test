package edgeTestCases.function;

import edgeTestCases.EDGEIntegrationTest;
import edgeTestCases.utils.Converter;
import edgeTestCases.utils.PubSubCommon;
import edgeTestCases.utils.client.ConnectionType;
import edgeTestCases.utils.client.EdgeDeviceMQTTChecker;
import edgeTestCases.utils.client.EdgeRuleFunctionContext;
import edgeTestCases.utils.client.MqttConnection;
import edgeTestCases.utils.msg.EdgeDeviceFunctionCallMsg;
import edgeTestCases.utils.msg.EdgeDeviceFunctionResultMsg;
...
/**
 * Test cases for edgeTestCases.function handler of edgeTestCases subscriptions.
 *
 * @author Zhao Meng
 */
@Slf4j
public class EdgeDeviceReFunctionTest extends EDGEIntegrationTest {
    ...
    /**
     * TestGoal: Test python edgeTestCases.function handler.
     *
     * Main steps:
     *  Step1: Connect a pub client and a sub client. Sub client subscribes the target topic.
     *  Step2: Publish one msg having return value of edgeTestCases.function and one msg not.
     *  Step3: Check target topic will only receive one msg and the context about edgeTestCases.mqtt features in msg should
     *   be correct.
     *
     * @throws Exception
     */
    ...
    /**
     * TestGoal: Test msg order of edgeTestCases.function handler.
     *
     * Main steps: Pub a few correct msgs with qos=0 to edgeTestCases.function with multi instances, check the order of results.
     *
     * @throws Exception
     */
    @Test
