...
public class EdgeDeviceTopicRouterTest extends EDGEIntegrationTest {
    ...
    /**
     * TestGoal: Test topic filter of wildcard of mqtt topics.(#/+)
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * TestGoal: Test unsub event of one topic for mqtt broker(Will not receive msgs of this topic anymore)
     *
     * @throws Exception
     */
    @Test
